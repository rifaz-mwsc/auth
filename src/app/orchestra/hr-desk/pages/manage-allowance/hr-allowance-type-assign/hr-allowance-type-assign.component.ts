...
import { HrAllowanceTypeAssignService } from './../../../shared/services/manage-allowance/hr-allowance-type-assign.service';
...
@Component({
  selector: 'app-hr-allowance-type-assign',
  templateUrl: './hr-allowance-type-assign.component.html',
  styleUrls: ['./hr-allowance-type-assign.component.scss']
})
export class HrAllowanceTypeAssignComponent implements OnInit {
  ...
  constructor(
    ...
    private _hrAllowanceTypeAssignBase: HrAllowanceTypeAssignService) {
  ...
  getRequestForPageOneOnlyWithFilter(pageNo) {
    ...
    this._hrAllowanceTypeAssignBase.getAllowanceTypeAssignListWithFilters(pageNo, this.defaultPaginationSize, this.employeeId).subscribe((data: any) => {
  ...
  public refreshApiData() {
    ...
    this.requestList = [];
    this.requestListWithPagination = [];
    console.log('refreshApiData -> Parent ', 'allowance-type-assign',);
    this.getRequestForPageOneOnlyWithFilter(1);
  }
}
