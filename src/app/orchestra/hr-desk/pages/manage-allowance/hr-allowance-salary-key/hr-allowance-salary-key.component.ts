...
import { HrAllowanceSalaryKeyBaseService } from './../../../shared/services/manage-allowance/hr-allowance-salary-key-base.service';
...
@Component({
  selector: 'app-hr-allowance-salary-key',
  templateUrl: './hr-allowance-salary-key.component.html',
  styleUrls: ['./hr-allowance-salary-key.component.scss']
})
export class HrAllowanceSalaryKeyComponent implements OnInit {
  ...
  constructor(
    ...
    private _hrAllowanceSalaryKeyBase: HrAllowanceSalaryKeyBaseService) {
  ...
  getRequestForPageOneOnlyWithFilter(pageNo) {
    ...
    console.log('getRequestForPageOneOnlyWithFilter this.salaryKeyName', this.salaryKeyName);
    console.log('getRequestForPageOneOnlyWithFilter this.salaryKeyDesciption', this.salaryKeyDesciption);
    this._hrAllowanceSalaryKeyBase.getSalaryKeyListWithFilters(pageNo, this.defaultPaginationSize, this.salaryKeyName, this.salaryKeyDesciption).subscribe((data: any) => {
  ...
  public refreshApiData() {
    ...
    this.requestList = [];
    this.requestListWithPagination = [];
    console.log('refreshApiData -> Parent ', 'allowance-salary-key',);
    this.getRequestForPageOneOnlyWithFilter(1);
  }
}
