...
@Component({
  selector: 'app-hr-leave-shorten',
  templateUrl: './hr-leave-shorten.component.html',
  styleUrls: ['./hr-leave-shorten.component.scss']
})
export class HrLeaveShortenComponent implements OnInit {

  toastrTimeOut: any = environment.appConfig.hrDesk.common.toastrTimeOut;
  modelCloseTimeOut: any = environment.appConfig.hrDesk.common.modelCloseTimeOut;
  // Page Info
  pageInfo: any = { module_name: 'leave', page_title: 'leave shorten' }
  // API Data
  showLoader: boolean;
  ...
  getRequestForPageOneOnlyWithFilter(pageNo) {
    ...
    this.hrLeaveRequestsBase.getHRDeskLeaveShortenRequestsWithFilters(pageNo, this.defaultPaginationSize, this.employeeId, this.leaveType, this.divisionName, this.departmentName, this.sectionName, this.selectedYear, this.selectedMonth).subscribe((data: any) => {
