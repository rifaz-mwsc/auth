...
@Component({
  selector: 'app-employee-profile-updates-view-card',
  templateUrl: './employee-profile-updates-view-card.component.html',
})
export class EmployeeProfileUpdatesViewCardComponent implements OnInit {
