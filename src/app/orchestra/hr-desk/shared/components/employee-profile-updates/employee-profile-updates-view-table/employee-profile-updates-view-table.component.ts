...
@Component({
  selector: 'app-employee-profile-updates-view-table',
  templateUrl: './employee-profile-updates-view-table.component.html',
})
export class EmployeeProfileUpdatesViewTableComponent implements OnInit {
