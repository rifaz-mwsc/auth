...
@Component({
  selector: 'app-employee-profile-updates-view-list',
  templateUrl: './employee-profile-updates-view-list.component.html',
})
export class EmployeeProfileUpdatesViewListComponent implements OnInit {
