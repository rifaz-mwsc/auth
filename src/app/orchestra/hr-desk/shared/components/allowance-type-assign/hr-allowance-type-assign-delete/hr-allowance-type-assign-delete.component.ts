...
@Component({
  selector: 'app-hr-allowance-type-assign-delete',
  templateUrl: './hr-allowance-type-assign-delete.component.html',
  styleUrls: ['./hr-allowance-type-assign-delete.component.scss']
})
export class HrAllowanceTypeAssignDeleteComponent implements OnInit {
  ...
  delete(allowanceType) {
    ...
    this._allowanceTypeAssignBase.deleteAllowanceTypeAssign(allowanceType.allowance_assigned_id, allowanceType.allowance_assigned_employee_id).subscribe((data: any) => {
