...
@Component({
  selector: 'app-hr-upload-leave-reject',
  templateUrl: './hr-upload-leave-reject.component.html',
  styleUrls: ['./hr-upload-leave-reject.component.scss']
})
export class HrUploadLeaveRejectComponent implements OnInit {
  ...
  reject(selectedleaveData) {
    ...
    this.leaveRequestsBase.postHRDeskLeaveRequestReject(
      {
      ...
      this.toastr.warning('Leave Request', 'Request rejected', { closeButton: true, timeOut: this.toastrTimeOut, progressBar: true, enableHtml: true });
