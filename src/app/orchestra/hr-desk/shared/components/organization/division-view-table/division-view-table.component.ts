...
@Component({
  selector: 'app-division-view-table',
  templateUrl: './division-view-table.component.html',
  styleUrls: ['./division-view-table.component.scss']
})
export class DivisionViewTableComponent implements OnInit {
