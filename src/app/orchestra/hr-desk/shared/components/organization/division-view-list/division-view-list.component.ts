...
@Component({
  selector: 'app-division-view-list',
  templateUrl: './division-view-list.component.html',
  styleUrls: ['./division-view-list.component.scss']
})
export class DivisionViewListComponent implements OnInit {
