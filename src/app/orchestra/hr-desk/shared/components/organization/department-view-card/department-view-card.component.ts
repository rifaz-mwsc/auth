...
@Component({
  selector: 'app-department-view-card',
  templateUrl: './department-view-card.component.html',
  styleUrls: ['./department-view-card.component.scss']
})
export class DepartmentViewCardComponent implements OnInit {
