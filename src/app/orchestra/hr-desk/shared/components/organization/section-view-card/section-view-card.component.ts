...
@Component({
  selector: 'app-section-view-card',
  templateUrl: './section-view-card.component.html',
  styleUrls: ['./section-view-card.component.scss']
})
export class SectionViewCardComponent implements OnInit {
