...
@Component({
  selector: 'app-section-view-table',
  templateUrl: './section-view-table.component.html',
  styleUrls: ['./section-view-table.component.scss']
})
export class SectionViewTableComponent implements OnInit {
