...
@Component({
  selector: 'app-hr-allowance-type-common-view',
  templateUrl: './hr-allowance-type-common-view.component.html',
  styleUrls: ['./hr-allowance-type-common-view.component.scss']
})
export class HrAllowanceTypeCommonViewComponent implements OnInit {
