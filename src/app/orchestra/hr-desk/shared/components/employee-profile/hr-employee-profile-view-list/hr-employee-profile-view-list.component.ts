...
@Component({
  selector: 'app-hr-employee-profile-view-list',
  templateUrl: './hr-employee-profile-view-list.component.html',
})
export class HrEmployeeProfileViewListComponent implements OnInit {
