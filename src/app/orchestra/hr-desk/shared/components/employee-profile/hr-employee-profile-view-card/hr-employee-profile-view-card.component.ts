...
@Component({
  selector: 'app-hr-employee-profile-view-card',
  templateUrl: './hr-employee-profile-view-card.component.html',
})
export class HrEmployeeProfileViewCardComponent implements OnInit {
