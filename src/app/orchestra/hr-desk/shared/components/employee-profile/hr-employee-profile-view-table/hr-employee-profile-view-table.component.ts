...
@Component({
  selector: 'app-hr-employee-profile-view-table',
  templateUrl: './hr-employee-profile-view-table.component.html',
})
export class HrEmployeeProfileViewTableComponent implements OnInit {
