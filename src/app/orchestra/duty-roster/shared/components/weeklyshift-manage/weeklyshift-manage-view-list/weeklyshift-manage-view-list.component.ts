...
@Component({
  selector: 'app-weeklyshift-manage-view-list',
  templateUrl: './weeklyshift-manage-view-list.component.html',
  styleUrls: ['./weeklyshift-manage-view-list.component.scss']
})
export class WeeklyshiftManageViewListComponent implements OnInit {
