...
@Component({
  selector: 'app-shiftgroup-view-table',
  templateUrl: './shiftgroup-view-table.component.html',
  styleUrls: ['./shiftgroup-view-table.component.scss']
})
export class ShiftgroupViewTableComponent implements OnInit {
