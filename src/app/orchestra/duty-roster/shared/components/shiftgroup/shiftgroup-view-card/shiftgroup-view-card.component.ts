...
@Component({
  selector: 'app-shiftgroup-view-card',
  templateUrl: './shiftgroup-view-card.component.html',
  styleUrls: ['./shiftgroup-view-card.component.scss']
})
export class ShiftgroupViewCardComponent implements OnInit {
