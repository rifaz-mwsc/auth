...
@Component({
  selector: 'app-shiftgroup-manage-supervisors-view-table',
  templateUrl: './shiftgroup-manage-supervisors-view-table.component.html',
  styleUrls: ['./shiftgroup-manage-supervisors-view-table.component.scss']
})
export class ShiftgroupManageSupervisorsViewTableComponent implements OnInit {
