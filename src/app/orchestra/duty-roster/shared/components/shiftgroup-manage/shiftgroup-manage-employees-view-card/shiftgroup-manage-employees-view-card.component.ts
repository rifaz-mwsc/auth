...
@Component({
  selector: 'app-shiftgroup-manage-employees-view-card',
  templateUrl: './shiftgroup-manage-employees-view-card.component.html',
  styleUrls: ['./shiftgroup-manage-employees-view-card.component.scss']
})
export class ShiftgroupManageEmployeesViewCardComponent implements OnInit {
