...
@Component({
  selector: 'app-shiftgroup-manage-employees-view-list',
  templateUrl: './shiftgroup-manage-employees-view-list.component.html',
  styleUrls: ['./shiftgroup-manage-employees-view-list.component.scss']
})
export class ShiftgroupManageEmployeesViewListComponent implements OnInit {
