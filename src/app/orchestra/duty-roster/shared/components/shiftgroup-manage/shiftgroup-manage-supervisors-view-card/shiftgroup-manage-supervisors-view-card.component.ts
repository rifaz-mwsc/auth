...
@Component({
  selector: 'app-shiftgroup-manage-supervisors-view-card',
  templateUrl: './shiftgroup-manage-supervisors-view-card.component.html',
  styleUrls: ['./shiftgroup-manage-supervisors-view-card.component.scss']
})
export class ShiftgroupManageSupervisorsViewCardComponent implements OnInit {
