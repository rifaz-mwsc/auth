...
@Component({
  selector: 'app-shift-sapupload-view-table',
  templateUrl: './shift-sapupload-view-table.component.html',
  styleUrls: ['./shift-sapupload-view-table.component.scss']
})
export class ShiftSapuploadViewTableComponent implements OnInit {
      ...
      this.requestList.forEach(elemt => {
        if (selectedData.ShiftId === elemt.ShiftId) {
          const sapuploadsExport = {
            ...
            Period: elemt.Period,
            StartDate: elemt.StartDate,
            EndDate: elemt.EndDate,
            Infotype: elemt.Infotype,
            ShiftCount: elemt.ShiftCount,
            NormalShiftRateAt: elemt.NormalShiftRateAt,
            // Selected: false,
          };
