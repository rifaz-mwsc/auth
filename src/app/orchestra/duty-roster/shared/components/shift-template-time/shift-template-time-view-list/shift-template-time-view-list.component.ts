...
@Component({
  selector: 'app-shift-template-time-view-list',
  templateUrl: './shift-template-time-view-list.component.html',
  styleUrls: ['./shift-template-time-view-list.component.scss']
})
export class ShiftTemplateTimeViewListComponent implements OnInit {
