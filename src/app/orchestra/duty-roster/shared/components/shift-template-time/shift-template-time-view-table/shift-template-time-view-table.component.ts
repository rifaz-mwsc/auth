...
@Component({
  selector: 'app-shift-template-time-view-table',
  templateUrl: './shift-template-time-view-table.component.html',
  styleUrls: ['./shift-template-time-view-table.component.scss']
})
export class ShiftTemplateTimeViewTableComponent implements OnInit {
